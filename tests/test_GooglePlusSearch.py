...
class test_GooglePlusSearch(unittest.TestCase):
	...
	def test_create_instance_with_valid_args(self):
		post = GooglePlusSearch(api_key=self.api_key, db=self.db, scorer=self.scorer, query=self.query)

	def test_create_instance_missing_args(self):
		try:
			post = GooglePlusSearch()
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_missing_api_key(self):
		try:
			post = GooglePlusSearch(None, self.db, self.scorer, self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_missing_db(self):
		try:
			post = GooglePlusSearch(self.api_key, None, self.scorer, self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_missing_scorer(self):
		try:
			post = GooglePlusSearch(self.api_key, self.db, None, self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_missing_query(self):
		try:
			post = GooglePlusSearch(self.api_key, self.db, self.scorer, None)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_invalid_api_key(self):
		try:
			post = GooglePlusSearch(4, self.db, self.scorer, self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_invalid_db(self):
		try:
			post = GooglePlusSearch(self.api_key, "Invalid", self.scorer, self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_invalid_scorer(self):
		try:
			post = GooglePlusSearch(self.api_key, self.db, "Invalid", self.query)
			self.fail()
		except TypeError:
			pass
	...
	def test_create_instance_invalid_query(self):
		try:
			post = GooglePlusSearch(self.api_key, self.db, self.scorer, 4)
			self.fail()
		except TypeError:
			pass